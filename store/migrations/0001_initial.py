# Generated by Django 3.2.7 on 2021-10-18 20:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('B', 'oc cho'), ('S', 'bac oc cho'), ('G', 'vang oc cho')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('paymentstatus', models.CharField(choices=[('P', 'dang cho thanh toan'), ('C', 'tra tien roi'), ('F', 'du me web ngu')], default='P', max_length=1)),
